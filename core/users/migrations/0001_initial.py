    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('otp_secret', models.TextField(blank=True, editable=False, null=True, verbose_name='OTP Secret')),
                ('is_2fa_enabled', models.BooleanField(default=False)),
                ('is_active', models.BooleanField(default=True)),
                ('is_staff', models.BooleanField(default=False)),
                ('is_admin', models.BooleanField(default=False)),
                ('is_superuser', models.BooleanField(default=False)),
                ('department', models.ForeignKey(help_text='Enter the department of the employee.', on_delete=django.db.models.deletion.CASCADE, to='users.department')),
